  ...
  return (
    <div className='container Profile'>
      ...
      <div className="d-flex justify-content-around mb-2 mx-auto ">
        <button className="col-sm-5 btn btn-clr btn-sm" type="button">My events</button>
        <button className="col-sm-5 btn btn-clr btn-sm" type="button">Recent Events</button>
      </div>
